  ...
  const navLinks = [
    {
      ...
      desc: "Explore available services near you",
      icon: "🔍",
    },
    {
      href: "/user/bookings",
      label: "Manage Bookings",
      desc: "View and track your booking history",
      icon: "📅",
    },
    {
      href: "/user/reviews",
      label: "Manage Reviews",
      desc: "See and edit reviews you've left",
      icon: "⭐",
    },
    {
      href: "/user/complaints",
      label: "File Complaint",
      desc: "Report an issue with a service",
      icon: "📋",
    },
  ];
        ...
        <div className="ud-shell">
          ...
          <div className="ud-header">
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {user ? (
                ...
                <span className="ud-loading">Loading account...</span>
              ) : null}
          ...
          <div className="ud-stats">
            <div className="ud-stat">
              <div className="ud-stat-num">{stats.total}</div>
              <div className="ud-stat-label">Total Bookings</div>
            </div>
            <div className="ud-stat">
              <div className={`ud-stat-num ${stats.completed > 0 ? "completed" : ""}`}>
                {stats.completed}
              </div>
              <div className="ud-stat-label">Completed</div>
            </div>
            <div className="ud-stat">
              <div className={`ud-stat-num ${stats.pending > 0 ? "active" : ""}`}>
                {stats.pending}
              </div>
          ...
          <div className="ud-nav">
            {navLinks.map(({ href, label, desc, icon }) => (
              <Link key={href} href={href} className="ud-nav-link">
